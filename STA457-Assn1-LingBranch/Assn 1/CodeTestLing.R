...
dataDir <- "~/Documents/STA457/STA457-Assn1/STA457-Assn1-LingBranch/Assn 1/DJ Data Monthly"
currDir <- "~/Documents/STA457/STA457-Assn1/STA457-Assn1-LingBranch/Assn 1"
...
dataDir <- "~/Documents/STA457/STA457-Assn1/STA457-Assn1-LingBranch/Assn 1/DJ Data Daily"
...
# 
# dj_ew_performance s<- ew_performance(mlogrets, dlogrets)
...
# lines(c(61:dim(mlogrets)[2]), dj_tsmom_performance$cumul_return, col="red")
# 
...
# lines(c(61:dim(mlogrets)[2]), dj_tsmom_performance$e_return, col="red")
...
# lines(seq(61,dim(mlogrets)[2],12), dj_tsmom_performance$ea_volatilities, col="red")
...
# lines(c(61:dim(mlogrets)[2]), dj_tsmom_performance$sharpes, col="red")
# 
# #kable
...
# get a table of the volatilities sigma_{s,t} for the regressions
...
predictiveRegression <- function(retX){
  num_stocks <- 30
  #number of periods of data provided
...
optimal_h_values<- predictiveRegression(mlogrets)
